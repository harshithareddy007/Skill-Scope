...
const roadmapSteps = [
  {
    ...
    description:
      "AI analyzes resume structure, ATS alignment, and recruiter compatibility.",
  },

  {
    ...
    description:
      "Missing technical and strategic skills are identified in real-time.",
  },

  {
    ...
    description:
      "Personalized roadmap generation based on career targets and growth velocity.",
  },

  {
    ...
    description:
      "Projects, milestones, and optimization loops are continuously updated.",
  },

  {
    ...
    description:
      "Your profile evolves toward the requirements of your desired role.",
  },
];
            ...
            >
              ...
              <motion.path
                ...
                style={{
                  ...
                  filter: "drop-shadow(0px 0px 12px rgba(232,93,42,0.9))",
                }}
              />
            </svg>
          </motion.div>
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="absolute inset-0 rounded-[30px] bg-[radial-gradient(circle_at_top_left,rgba(232,93,42,0.18),transparent_60%)] pointer-events-none"
        />
        ...
        <div className="relative z-10 flex items-center justify-between transform-style-3d">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[0.2em] font-mono text-[var(--accent)]/70 mb-1">
                Phase 0{index + 1}
              </p>
        ...
        <p className="relative z-10 mt-6 text-[15px] leading-relaxed text-zinc-400">
          {step.description}
        </p>
